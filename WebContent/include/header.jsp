				...
				<td><a href="${contextPath}/mycon/mypageForm.do" style="color: #fff;">마이 페이지</a></td>
  				...
  				<div class="col-12 w-100 text-center" style="margin-top: -100px;">
			        ...
			        <ul class="navbar-nav m-auto">
			          <li class="nav-item active"><a href="${contextPath}" class="nav-link" style="font-size: 22px; font-family:나눔고딕"><b>메인</b></a></li>
			          ...
			          <li class="nav-item"><a href="${contextPath}/ev/listEvent.do" class="nav-link" style="font-size: 22px; font-family:나눔고딕"><b>이벤트</b></a></li>
			          
			     <c:if test="${is_admin == 1}">     
			          <li class="nav-item"><a href="${contextPath}/admin/adminPage.do" class="nav-link" style="font-size: 22px; font-family:나눔고딕; margin-top: 80px;"><b>관리자 페이지</b></a></li>
			     </c:if>
					  <li class="nav-item"><a href="${contextPath}/blog.jsp" class="nav-link" style="font-size: 22px; font-family:나눔고딕; margin-top: 80px;"><b>예매하기</b></a></li>
			          <li class="nav-item"><a href="${contextPath}/notice/listNotice.do" class="nav-link" style="font-size: 22px; font-family:나눔고딕; margin-top: 80px;"><b>공지사항</b></a></li>
			     <c:if test="${id==null}">
			          <li class="nav-item"><a href="${contextPath}/member/login.do" class="nav-link" style="font-size: 22px; font-family:나눔고딕; margin-top: 80px;"><b>로그인</b></a></li>
			     </c:if>  
			        </ul>
			      </div>
  				</div>
