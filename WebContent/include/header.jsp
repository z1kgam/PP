...
<%-- 			     </c:if> --%>
					  <li class="nav-item" style="margin-right: 0;"><a href="${contextPath}/main/news.do" class="nav-link" style="font-size: 14px; font-family: 'Nanum Gothic Coding', monospace; margin-top: 65px;">공연/전시소식</a></li>
