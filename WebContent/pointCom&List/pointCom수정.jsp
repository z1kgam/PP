...
<jsp:include page="../include/header.jsp" />
	...
	<div class="page-header" style="padding-top: 50px;">
    	...
    	<h1 style="margin-bottom: 10px; font-size: 40px;">Check</h1>
			...
			<div class="row">
				<form action="${contextPath}/mycon/addpointCom.do" method="post">
					...
					<div class="form-group text-center">
						...
						<input type="submit" value="입금확인완료" class="btn btn-primary" style="background-color: #00E7D6 !important; border-color: #00E7D6 !important; color: #fff !important; margin-bottom: 50px;">
						<button type="button" class="btn btn-success" onclick="location.href='${contextPath}'" style="background-color: #A9FF7F !important; border-color: #A9FF7F !important; color: #fff !important; margin-bottom: 50px;">메인으로</button>
					</div>
				</form>
			</div>
	</div>
