...
<jsp:include page="../include/header.jsp" />
 ...
 <div class="container" style="width: 70%;">
	<div class="page-header" style="padding-top: 50px;">
    	...
    	<h1 style="margin-bottom: 50px;">Deposit</h1>
    <hr/>
    </div>
	 	...
	 	<div class="row">
			...
			<button type="button" onclick="btnDelete()" class="btn btn-primary pull-right" style="background-color: #00E7D6 !important; border-color: #00E7D6 !important; color: #fff !important; margin-bottom: 50px;">입금내역 비우기</button>
