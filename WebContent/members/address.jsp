...
<div class="container" style="width: 70%;">
	...
	<div id="Naddress" style="display:none;">
		<form action="${contextPath}/member/NaddressAction.do" method="post" name="addressForm2">
			...
			<div class="form-group text-center">
	              <input type="submit" class="btn btn-info" style="background-color: #ff0 !important;" value="배송지 수정">
	              <button type="button" class="btn btn-warning" style="color: #fff;" onclick="location.href='${contextPath}'">메인으로</button>
	        </div>
		</form>
	</div>
</div>
